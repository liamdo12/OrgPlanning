...
/**
 * The shell the account record is shown in.
 *
 * Which account is open lives in the query string, which is why this component
 ...
 */
export function UserDrawer({ title, children }: { title: string; children: ReactNode }) {
